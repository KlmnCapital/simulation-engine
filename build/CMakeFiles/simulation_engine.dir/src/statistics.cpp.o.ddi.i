# 0 "/home/nemeleks/kelemen_capital/dev/simulation_engine/src/statistics.cpp"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/nemeleks/kelemen_capital/dev/simulation_engine/src/statistics.cpp"
...
# 97 "/home/nemeleks/kelemen_capital/dev/simulation_engine/src/statistics.cpp"
    }
    ...
    std::string Statistics<depth>::formatTicksAsDollars(Ticks ticks) const {
        ...
        oss << std::fixed << std::setprecision(2) << "$"
            << (static_cast<double>(ticks.value()) / 1'000'000'000.0);
        return oss.str();
    }
